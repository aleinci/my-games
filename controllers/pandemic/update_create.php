...
require "controllers/pandemic/viewRecord.php";




$count = mysqli_query($connection,"SELECT * FROM pandemic WHERE name = '$name'");
 //verificamos si el user exite con un condicional
if( mysqli_num_rows($count) == 0){//no existe la cuenta
	$register = "INSERT INTO pandemic(`name`) VALUES ('$name')";
