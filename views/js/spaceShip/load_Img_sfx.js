const font = new FontFace('MyFont', 'url(' + srcImg + 'FSEX300.ttf)');
...
function LoadImage() {//imagenes
	...
	energy = new Image();
	energy.src=srcImg + "energy.png";
	

	nave = new Image();
	nave.src=srcImg + "nv.png";

	//pausa

	pauseI = new Image();
	pauseI.src = srcImg + "pause/pause.png";
	

	start = new Image();
	start.src = srcImg + "pause/btn-start.png";
	

	reanudar = new Image();
	reanudar.src = srcImg + "pause/resume.png";
	

	exit = new Image();
	exit.src = srcImg + "pause/exit.png";
	
	

	btnPausa = new Image();
	btnPausa.src = srcImg + "pause/pause buttons.png";

	//main menu

	playM = new Image();
	playM.src = srcImg + "mainMenu/play.png";


	playB = new Image();
	playB.src = srcImg + "mainMenu/playbtn.png";
	

	btnflechas = new Image();
	btnflechas.src = srcImg + "mainMenu/arrows-btn.png";
	
	

	bordeSel = new Image();
	bordeSel.src = srcImg + "mainMenu/bordeMap.png";
	

	sMapColor = new Image();
	sMapColor.src = srcImg + "mainMenu/select C_M2.png";

	nameBox = new Image();
	nameBox.src = srcImg + "mainMenu/nameBox2.png";

	btnCredit = new Image();
	btnCredit.src = srcImg + "mainMenu/buttonCredits.png";

	btnCTG = new Image();
	btnCTG.src = srcImg + "mainMenu/buttonCTG.png";

	btnLeader = new Image();
	btnLeader.src = srcImg + "mainMenu/buttonLeader.png";

	screenMsg = new Image();
	screenMsg.src = srcImg + "mainMenu/msgResolution.png";
	

	//game over

	gameO = new Image();
	gameO.src = srcImg + "gameOver/Game Over.png";

	btnGO = new Image();
	btnGO.src = srcImg + "gameOver/btnGO.png";
	

	sabias_q = new Image();
	sabias_q.src = srcImg + "gameOver/You know what.png";
	

	sQuit = new Image();
	sQuit.src = srcImg + "gameOver/Quit.png";
	

	menuScore = new Image();
	menuScore.src = srcImg + "gameOver/score.png";
	

	//mapas

	map0 = new Image();
	map0.src = srcImg + "maps/background/FA 1-01.jpg";

	map1 = new Image();
	map1.src = srcImg + "maps/background/FA 2-02.jpg";

	map2 = new Image();
	map2.src = srcImg + "maps/background/FA 3-03.jpg";

	map3 = new Image();
	map3.src = srcImg + "maps/background/FA 4-04.jpg";

	map4 = new Image();
	map4.src = srcImg + "maps/background/FA 5-05.jpg";

	map5 = new Image();
	map5.src = srcImg + "maps/background/FA 6-06.jpg";

	map6 = new Image();
	map6.src = srcImg + "maps/background/FA 7-07.jpg";

	map7 = new Image();
	map7.src = srcImg + "maps/background/FA 8-08.jpg";

	map8 = new Image();
	map8.src = srcImg + "maps/background/FA 9-09.jpg";

	map9 = new Image();
	map9.src = srcImg + "maps/background/FA 10-10.jpg";


	//tubos

	tubo0 = new Image();
	tubo0.src = srcImg + "maps/tube/tubes 1-01.png";

	tubo1 = new Image();
	tubo1.src = srcImg + "maps/tube/tubes 2-01.png";

	tubo2 = new Image();
	tubo2.src = srcImg + "maps/tube/tubes 3-01.png";

	tubo3 = new Image();
	tubo3.src = srcImg + "maps/tube/tubes 4-01.png";

	tubo4 = new Image();
	tubo4.src = srcImg + "maps/tube/peaks 1-01.png";

	tubo5 = new Image();
	tubo5.src = srcImg + "maps/tube/tubes 5-01.png";

	//como jugar

	jugar = new Image();
	jugar.src = srcImg + "play.png";

	//creditos

	iCredits = new Image();
	iCredits.src = srcImg + "credits/credits.png";

	iProgram = new Image();
	iProgram.src = srcImg + "credits/developer.png";

	iCompM = new Image();
	iCompM.src = srcImg + "credits/musicCom.png";

	iDesign = new Image();
	iDesign.src = srcImg + "credits/Background.png";

	iQuitC = new Image();
	iQuitC.src = srcImg + "credits/exitC.png";
	...
	if (mMenu) {
		...
		screenMsg.addEventListener("load", loadHandler, false);
		...
		tubo5.addEventListener("load", loadHandler, false);
		...
		jugar.addEventListener("load", loadHandler, false);
...
function LoadSound() {//sonido
	...
	exp = new Audio(srcSfx + "Explosion7.wav");
    
    pts = new Audio(srcSfx + "Pickup_Coin39.wav");

    hitC = new Audio(srcSfx + "Hit_Hurt2.wav");

    changeS = new Audio(srcSfx + "Powerup4.wav");

    point = new Audio(srcSfx + "Pickup_Coin71.wav");

    //musica
    
    music1 = new Audio(srcSfx + "music/Solve The Puzzle.ogg");//listo
    music2 = new Audio(srcSfx + "music/Karibu Watu Wangu.ogg");
    music3 = new Audio(srcSfx + "music/Spring Village.ogg");
    music4 = new Audio(srcSfx + "music/Mall.ogg");//listo
    music5 = new Audio(srcSfx + "music/Friends.ogg");//listo
    music6 = new Audio(srcSfx + "music/Goliath's Foe.ogg");
    music7 = new Audio(srcSfx + "music/1st Sonata - Snowy Stars.ogg");
    music8 = new Audio(srcSfx + "music/Interplanetary Odyssey.ogg");//listo
    music9 = new Audio(srcSfx + "music/Su Turno.ogg");
    music10 = new Audio(srcSfx + "music/Lyonesse.ogg");//listo
