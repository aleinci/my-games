...
function LoadImage() {//imagenes
	...
	nave = new Image();
	nave.src="views/img/Texture/nv.png";
	...
	btnPausa = new Image();
	btnPausa.src = "views/img/Texture/pause/pause buttons.png";
	...
	btnLeader = new Image();
	btnLeader.src = "views/img/Texture/mainMenu/buttonLeader.png";
	
	screenMsg = new Image();
	screenMsg.src = "views/img/Texture/mainMenu/msgResolution.png";
	...
	menuScore = new Image();
	menuScore.src = "views/img/Texture/gameOver/score.png";
	...
	map9 = new Image();
	map9.src = "views/img/Texture/maps/background/FA 10-10.jpg";
	...
	tubo4 = new Image();
	tubo4.src = "views/img/Texture/maps/tubes/peaks 1-01.png";

	//como jugar

	jugar = new Image();
	jugar.src = "views/img/Texture/play.png";
...
function LoadSound() {//sonido
	...
	exp = new Audio("views/img/sound/spaceship/Explosion7.wav");
    
    pts = new Audio("views/img/sound/spaceship/Pickup_Coin39.wav");

    hitC = new Audio("views/img/sound/spaceship/Hit_Hurt2.wav");

    changeS = new Audio("views/img/sound/spaceship/Powerup4.wav");

    point = new Audio("views/img/sound/spaceship/Pickup_Coin71.wav");

    //musica
    
    music1 = new Audio("views/img/sound/spaceship/music/Solve The Puzzle.ogg");//listo
    music2 = new Audio("views/img/sound/spaceship/music/Karibu Watu Wangu.ogg");
    music3 = new Audio("views/img/sound/spaceship/music/Spring Village.ogg");
    music4 = new Audio("views/img/sound/spaceship/music/Mall.ogg");//listo
    music5 = new Audio("views/img/sound/spaceship/music/Friends.ogg");//listo
    music6 = new Audio("views/img/sound/spaceship/music/Goliath's Foe.ogg");
    music7 = new Audio("views/img/sound/spaceship/music/1st Sonata - Snowy Stars.ogg");
    music8 = new Audio("views/img/sound/spaceship/music/Interplanetary Odyssey.ogg");//listo
    music9 = new Audio("views/img/sound/spaceship/music/Su Turno.ogg");
    music10 = new Audio("views/img/sound/spaceship/music/Lyonesse.ogg");//listo
